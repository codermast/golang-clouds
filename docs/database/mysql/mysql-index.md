...
### 二叉树
![二叉树](/assets/database/mysql/mysql-index/2023-04-10-22-50-55.png)
...
![红黑树](/assets/database/mysql/mysql-index/2023-04-10-22-55-17.png)
...
![B树](/assets/database/mysql/mysql-index/2023-04-10-23-09-07.png)
...
![B+树](/assets/database/mysql/mysql-index/2023-04-10-23-16-28.png)

### 优化的B+树

MySQL索引数据结构对经典的B+Tree进行了优化。在原B+Tree的基础上增加了一个指向相邻叶子结点的链表指针，就形成了带有顺序指针的B+Tree，提高区间访问的性能。

![MySQL优化的B+树](/assets/database/mysql/mysql-index/2023-04-10-23-21-08.png)
...
![回表查询](/assets/database/mysql/mysql-index/2023-04-11-00-05-50.png)
